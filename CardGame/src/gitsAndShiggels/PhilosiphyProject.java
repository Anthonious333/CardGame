...
public class PhilosiphyProject extends Application {
	...
	String[] bodies = {
			...
			"Dark Matter has come to our attention not because we have seen or interacted with it, but because of the process of elimination. Basically we have no idea what is in the dark space in the universe keeping galaxies together. To solve this\n gap in logic we came up with dark matter as a solution. The current state of the elimination is that it is not normal matter, it is not antimatter, and it is not any sort of black hole related object. This is relevant because it makes up a large part of our universe but is somehow completely un observable, making us question if it is real or made up.",
			"Energy is a sort of currency transferred around the universe to pay for actions things take. Just like matter, it was scattered at the big bang and cannot be created or destroyed, only changed. Whenever we burn things to make electricity\n we are just taking potential energy and changing it into electricity. then that electricals get turned back into heat and light, then the light back to heat and the cycle continues. This is significant because like with society, nothing can happen without currency.",
			...
			"Great Filters are a concept that prevents intelligent life from reaching the next big step in evolution. In order for life to exist it needs to overcome hundreds, maybe thousands of these great filters like oxygen, temperature, and life to\n actually spark. Our planet has survived a couple famous filters such as the ice age, the dinosaur extinction, and many didesses. This is relevant to put into perspective the rarity we as a living planet are and make us think more about our existence.",
			"Heisenberg Uncertainty Principle states that we cannot know the location and trajectory of any particle. This is because inorder to see something we need to have some sort of energy bounce off of it, in doing so we change the momentum and\n position of the particle being observed. There are ways to see where it is and to get its momentum, but trying to do both is like trying to feel something in your teeth and get it out at the same time, it just does not work. This is relevant because it reminds us of our limitations and challenges us to get through.", 
			"infinity is big, there are more real numbers than you could write out. but that is not how big infinity really is. think about this, for each number, say between 0 - 1, there are an infinite amount of unique decimals, easily shown like this\n 0.1, 0.11, 0.111, 0.1111… these repeating ones go on forever making it the same size as the infinity of real numbers, but that means there are an infinite amount of infinities in infinity. So the answer to how big is infinity is really yes because within infinity lies more infinities. This is relevant as it proves to us that there is truly never a lack of something in our world, there is always something someone has never seen or done.",
			...
			"Laplace’s Angel is a theory that if there were such a being that knew the exact position over every atom and its momentum, and had the ability to calculate the universe, it would be able to know everything that has and will happen. This is\n based on the idea of cause and effect being predictable. When the computer was first invented some people thought the angel may become a reality, but modern science states that there is no possible way for something like that to exist due to the Heisenberg Uncertainty Principle. This is relevant because though it is not yet possible it provides a solid theoretical example of a time machine.",
			"Matter is what is otherwise known as solid material. matter is composed of atoms and cannot be created or destroyed. If you break a plate, the matter from the plate simply scatters but does not and will never disappear. matter has varying\n properties, the most notable of which is the state of the matter. the state of matter changes with the temperature or how much energy the atoms have stored inside. This is relevant because it shows the universe is made of things and can never be destroyed, only changed. ",
			"A Neutrino is a particle way too small for almost anything to detect. A neutrinos' size is manu times smaller than an atom, meaning it can easily glide through almost anything. They are created through violent reactions such as potassium \ndecaying, nuclear reactors, and particle accelerators. The only way we have found to detect them is to hope that one collides with an atom, realing blue light the same way a plane would produce a sonic boom and capture the light from that interaction. This is relevant because it allows you to understand that some of the things we know about our universe really only came to our attention by chance, so it helps us question things we perceive as fact",
			...
			"P-Branes are a part of string theory that is not a string. string theory supports the idea of a higher dimensional string with the same properties of a string in string theory, these high dimensional strings are called p-branes, and come \nfrom the word membrane. a brane can be up to 9 dimensions as each of them vibrate at a dimension 2 higher than themself and 11 is the last stable dimension. This is an important idea because it tells us what the universe beyond our understanding contains and gives us a larger scope of thinking.", 
			...
			"String Theory is a theory that states the smallest thing in our world is a one dimensional string that vibrates so fast it creates 3 dimensional objects. The key is to have the string vibrate at or faster than the speed of light. Though it \nwas first only thought of with the string that makes up our 3 dimensional space, it was discovered that the same theory can be applied to height dimensions. The rule of thumbs is when an object vibrates fast enough it makes an object 2 dimensions higher than itself. This means if you vibrated a 2 dimensional object fast enough it would become a time object. This is relevant as it connects multidimensional planes with higher and lower ones providing people a more connected view on reality.",
			...
			"Universe The universe, put simply, is everything within the human line of sight. anything we have seen makes up our universe. This does not mean that there is nothing past our line of sight, our universe is constantly expanding as more and \nmore light reaches our planet. The idea of another or alternate universe is that there are things in our current universe that exist nowhere in the other one or vice versa. This is relevant as it provides a sense of the true expanse of what we know.",
			...
			"Waves is a disturbance that travels from place to place. basically one atom hits another, that hits another and so on. This constant transference of force is called a wave. waves are used for many things but the most common application is \nfor us to observe our universe. On a day to day basis we see light waves and this allows us to see physical things in our world, but we also send waves into space to see what is happening there. This is relevant as waves are the main way we perceive our universe and without them we would literally be in the dark about a lot of things.",
			...
			"Learning is a process abundant in our day to day lives, for me learning is happening whether i like it or not. During this project I have kept track of what I have learnt and thought it was quite interesting. First off, I have learnt \nthat I don't like keeping track of my learning, this seems odd to me as normally I enjoy exploring my own consciousness. however this form of understanding how i understand things was a little too much for my brain to be comfortable with. Secondly, I learnt that small can be VERY small. Before this unit I was blissfully unaware just how small we understand about our world. string theory and the idea of vibrating objects to create higher planes make me wonder about what a 0 dimensional object might be, just a point maybe? Lastly, I learnt about just how vast our universe is. I didn't realize that there was more than one dimension above us, time I can visualize but things higher than that make my head spin. The sheer scale of our universe is so huge that this idea of there being more than one, even an infinite number, or how there are infinite infinities simply makes me question whether my definitions of bug and small really exist. long story short, I found this project very enlightening even if I did not enjoy reflection in it as much."
	};
	
	public void back (Scene oldScene) {
		myStage.setScene(oldScene);
	}
	...
	public void openBtn (String title, String body) {
		btnBack.setOnAction(event -> back(myStage.getScene()));
